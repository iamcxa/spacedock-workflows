...
#
# Folded from the retired PR-feedback re-entry skill (2026-04-21, entity 064
# pr-feedback-fold; harness-diet cut principle #2: separate-skill-for-small-function
# → inline-in-parent with tag). Full history: git log --follow this file + the
# docs/ship-flow/_archive/pr-feedback-fold.md archive once this entity ships.
# Mechanics: (1) flip frontmatter `status:` to target-status,
...
# Inline VCS detection (ported from the retired PR-feedback re-entry skill's
# V1-V3 steps; self-contained per harness-diet principle — full preamble
# extraction deferred to 046f preamble-extraction)
