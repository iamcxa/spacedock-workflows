...
check_skill_count() {
  ...
  local UTILITY_SKILLS=(add-todos ship-onboard ship-runtime-detect domain-registry ui-verify test-driven-development verify-reviewer-panel doc-sync distill-reference codex-gate harvest-decide memory-cleanup ship-epic)
