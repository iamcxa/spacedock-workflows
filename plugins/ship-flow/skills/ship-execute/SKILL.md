...
```bash
bash "${CLAUDE_PLUGIN_ROOT:-plugins/ship-flow}/lib/check-guidance-receipt.sh" \
  --config=.claude/ship-flow/skill-routing.yaml \
  --files=<task-files> \
