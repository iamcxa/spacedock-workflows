...
- resolved shape artifact (`shape.md`, with legacy `shape.md` fallback alias, or entity `## Sharp Output`) → `### Done Criteria`, `### Size Assessment`
