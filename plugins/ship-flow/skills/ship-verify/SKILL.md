---
name: ship-verify
description: "Layer A delegation: e2e-pipeline and ship-flow:ui-verify own UI-DC verification; pr-review-toolkit and ship-flow:verify-reviewer-panel own reviewer lenses. Use when verifying execute output before ship, including `/verify`, `/ship`, live worktree checks, UI DCs, e2e, reviewer panel, or NIT fixes."
user-invocable: true
