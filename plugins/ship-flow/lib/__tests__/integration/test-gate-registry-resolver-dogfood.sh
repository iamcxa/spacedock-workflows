#!/usr/bin/env bash
# integration/test-gate-registry-resolver-dogfood.sh
#
# Host artifacts needed:
#   docs/ship-flow/README.md — adopted workflow README with gate registry docs
#
...
echo "=== integration: gate-registry-resolver README ==="
