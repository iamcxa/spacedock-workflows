...
Source: ~/.claude/skills/gstack/review/specialists/performance.md
Purpose: ship-flow plugin self-contained review checklists
After /spacedock:overhaul: plugins/ship-flow/lib/review-checklists/specialists/performance.md
-->
