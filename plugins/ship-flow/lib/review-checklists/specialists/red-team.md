...
Source: ~/.claude/skills/gstack/review/specialists/red-team.md
Purpose: ship-flow plugin self-contained review checklists
After /spacedock:overhaul: plugins/ship-flow/lib/review-checklists/specialists/red-team.md
-->

# Red Team Review

Scope: When diff > 200 lines OR any specialist (especially security) found a CRITICAL finding. Runs AFTER other specialists so it can see their findings.
